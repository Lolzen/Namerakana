...
f:SetScript("OnEvent", function(self, event, addon)
	if addon == "Namerakana" then
		...
		cb1:SetScript("OnClick", function(self)
			Namerakana.kick.show = cb1:GetChecked()
		end)
		...
		-- // stunframe related // --
		local header2 = ns.panel:CreateFontString(nil, "ARTWORK", "GameFontHighlight")
		header2:SetText("|cff5599ffStuns|r")
		header2:SetPoint("TOPLEFT", picker2, "BOTTOMLEFT", 20, -30)
		
		local cb2 = CreateFrame("CheckButton", "show_stunframe", ns.panel, "ChatConfigCheckButtonTemplate")
		show_stunframeText:SetText(L["Show stunwindow"])
		cb2:SetChecked(Namerakana.stun.show)
		cb2:SetPoint("TOPLEFT", header2, "BOTTOMLEFT", 0, -5)
		
		cb2:SetScript("OnClick", function(self)
			Namerakana.stun.show = cb2:GetChecked()
		end)
--[[		
		local smallheader1 = ns.panel:CreateFontString(nil, "ARTWORK", "GameFontHighlightSmall")
		smallheader1:SetText(L["Bars"])
